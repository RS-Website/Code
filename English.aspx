            ...
            <nav id="sidebarplaylist" style ="margin-top:180px;margin-left:10px;display:none;width:400px;background-color:blue;" class="active">
                            ...
                            <div id="HomePage" class="row BorderDiv" divType="pageContent">
                                ...
                                <div class="col-md-12" style ="font-size:15px;"  >
                                    <center style="background-color:#FFF7EB;padding:6px;"><h4>** Video Shabds have been re-organised into a new page <a href="ShabdsByOccasion.html"><u>Shabds by Special Occasions</u></a>. Option to access in 'Library' menu as well. **</h4></center>
